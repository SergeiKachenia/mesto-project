...
* 21.11.2021 - Использован сборщик Webpack, его плагины для работы с CSS и HTML, PostCSS, а также Babel для транспиляции JS-кода. Добавлена валидация всех форм.
